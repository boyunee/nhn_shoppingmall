...
public class ViewResolver {
    ...
    public  String getPath(String viewName){
        ...
        if (viewName.startsWith("/")) {
            String substring = viewName.substring(1);
    ...
    public boolean isRedirect(String viewName){
        ...
        if (viewName.toLowerCase().contains(REDIRECT_PREFIX.toLowerCase())) {
            return true;
    ...
    public String getRedirectUrl(String viewName){
        ...
        if (viewName.toLowerCase().contains(REDIRECT_PREFIX.toLowerCase())) {
            String url = viewName.substring(viewName.indexOf(":") + 1);
            return url;
        }
        return "";
    }
    ...
    public String getLayOut(String viewName){
        ...
        */
        if (viewName.toLowerCase().contains("admin".toLowerCase())) {
