...
public class UserRepositoryImpl implements UserRepository {
    ...
    public int update(User user) {
        ...
        String sql = "update users set user_name=?, user_auth=?, user_birth=?, user_point=?, user_password=? where user_id=?";
        Connection connection = DbConnectionThreadLocal.getConnection();
        try(PreparedStatement preparedStatement = connection.prepareStatement(sql);
        ) {
            preparedStatement.setString(1, user.getUserName());
            preparedStatement.setString(2, user.getUserAuth().toString());
            preparedStatement.setString(3, user.getUserBirth());
            preparedStatement.setInt(4, user.getUserPoint());
